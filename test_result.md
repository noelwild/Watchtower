...
agent_communication:
  ...
  - agent: "testing"
    message: "STARTING ENHANCED ROSTER PRODUCER 14-DAY MEMBER SPREAD TESTING - Beginning comprehensive testing of the enhanced Roster Producer with detailed member information display including VP numbers, ranks, OSTT dates, ADA status, special qualifications, seniority years, and 14-day schedule grid with color-coded shifts. Will test all aspects of the new interface as requested in the review."